...
# STATO ATTUALE: FASI 0-3 ✅ + RICOGNIZIONE MOBILE ✅ + FASE 4 AUDIO ✅ — prossima: Fase 5

## Fase 4 — Audio ✅
Troncone A (SFX): colpo, punto, rete, salto, fine match. Famiglia feedback: palla->ImpactFeedback,
player->PlayerFeedback, match->MatchFeedback. Troncone B (musica+volume): MusicPlayer persistente,
AudioMixer (Master/Music/SFX), VolumeController (linear->dB), VolumeSettings (SaveData<->mixer),
slider nel menu. Placeholder audio sintetizzati (net/jump/whistle/bgm).
Rimandato a Fase 5: tap UI/menu SFX.
...
- [x] B3: SaveData guadagna musicVolume/sfxVolume (default 1). SaveSystem.Load ->
